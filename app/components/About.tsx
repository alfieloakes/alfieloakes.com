    ...
    <div className="container px-4 mb-4">
      <div className="grid sm:grid-cols-1 gap-4">
        <div className="col-span-12">
          ...
          <p className="mb-4">In my free time I enjoy playing cricket, long dog walks and watching movies and TV shows.</p>
          <p className="mb-4">This website will soon serve as a hub, where I showcase my thoughts through blog posts.</p>
        </div>
      </div>
    </div>
  );
